      ...
      <div className="drawer drawer-end">
        ...
        {status === "authenticated" ? (
          <div className="dropdown dropdown-end">
            <div
              tabIndex={0}
              role="button"
              className="cursor-pointer relative h-10 w-10 overflow-hidden rounded-full"
            >
              <Image
          ...
          <div onClick={handleDrawer} className="drawer-content">
        ...
        ${!isLogin ? "text-black" : "text-white"}`}
            ...
            <div className="mt-12">
              <AnimatePresence mode="wait">
                {isLogin ? (
                  <Animate type="fadeLeft" key="login">
                    <Login />
                  </Animate>
                ) : (
                  <Animate type="fadeRight" key="register">
                    <Register />
                  </Animate>
                )}
              </AnimatePresence>
