...
const Banner = () => {
  ...
  return (
    <section
      id="BannerSection"
      className="relative h-150 md:h-screen overflow-hidden bg-gray-950 text-white"
    >
      {/* Background Images */}
      {images.map((img, index) => (
        ...
        >
          <div className="relative w-full h-150 md:h-300 lg:h-screen">
            <Image
              src={img}
              alt="Care Service"
              fill
      ...
      >
            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <button
                  ...
                  className="px-5 py-2 rounded-2xl backdrop-blur-lg border border-accent bg-base-200/30 transition-all duration-300 flex items-center gap-2 justify-center hover:scale-[1.03] cursor-pointer w-fit"
                >
                  Learn More
        ...
        shadow-[0_20px_60px_rgba(0,0,0,0.4)] hover:-translate-y-3 duration-500"
              >
                ...
                <h3 className="text-xl font-bold mb-3">Verified Caregivers</h3>
