...
const ProfileCard = ({ user }) => {
  ...
  return (
    <Animate
      type="zoom"
      className="bg-base-200 shadow-xl border border-accent rounded-2xl"
    >
      <Animate className="py-4 md:py-8 px-6">
        {/* Header */}
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{user.contact || "Not Added"}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{user.nid || "Not Added"}</p>
              </div>
            </div>
      ...
      <EditProfileModal user={user} dialogRef={dialogRef} />
    </Animate>
  );
};
