            ...
            <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden z-30">
                ...
                focus:border-[#11B2ED] focus:ring-2 focus:ring-[#11B2ED]/30 outline-none transition`}
                        ...
                        <button
                            ...
                            className="btn border-none w-full py-5 rounded-xl bg-linear-to-bl from-blue-700 to-cyan-300 text-white font-semibold transition duration-300 shadow-lg disabled:opacity-70 hover:scale-105"
                        >
